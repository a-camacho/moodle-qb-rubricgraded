 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qbehaviour_rubricgraded_walkthrough_testcase extends qbehaviour_walkthrough_test_base {
    public function test_manual_graded_essay() {
        ...
        $this->assertEquals('rubricgraded', $this->quba->get_question_attempt(
    ...
    public function test_manual_graded_truefalse() {
        ...
        $this->start_attempt_at_question($tf, 'rubricgraded', 2);
